...
import { CustomClaudeEndpointDialog } from "./CustomClaudeEndpointDialog";
...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  /**
   * Offer the "Custom endpoint…" row in the Claude section, opening the
   * custom Claude endpoint dialog. Opt-in so surfaces like the settings
   * default-model picker don't grow an instance-creation affordance.
   */
  enableCustomClaudeEndpoint?: boolean;
}) {
  const [uncontrolledIsMenuOpen, setUncontrolledIsMenuOpen] = useState(false);
  const [isCustomEndpointDialogOpen, setIsCustomEndpointDialogOpen] = useState(false);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <ModelPickerContent
            ...
            {...(props.enableCustomClaudeEndpoint
              ? {
                  onRequestCustomClaudeEndpoint: () => {
                    setIsMenuOpen(false);
                    setIsCustomEndpointDialogOpen(true);
                  },
                }
              : {})}
          />
      ...
      {props.enableCustomClaudeEndpoint ? (
        <CustomClaudeEndpointDialog
          open={isCustomEndpointDialogOpen}
          onOpenChange={setIsCustomEndpointDialogOpen}
        />
      ) : null}
    </>
  );
